...
Revision ID: f745a579dc3a
Revises: 
Create Date: 2022-05-31 13:15:46.153074
...
def upgrade():
    ...
    op.create_table('routes_warnings',
    ...
    op.create_table('routes_sections',
    sa.Column('route_id', sa.Integer(), nullable=True),
    sa.Column('section_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['route_id'], ['routes.id'], ),
    sa.ForeignKeyConstraint(['section_id'], ['sections.id'], )
    )
    op.create_table('sections_warnings',
    sa.Column('section_id', sa.Integer(), nullable=True),
    sa.Column('warning_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['section_id'], ['sections.id'], ),
    sa.ForeignKeyConstraint(['warning_id'], ['warnings.id'], )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('sections_warnings')
    op.drop_table('routes_sections')
    op.drop_table('sections')
    op.drop_table('routes_warnings')
